...
Meteor.methods({
	'insertSliderData': function(title, imgname, imgfile, date){
		homeslider.insert({title:title, sliderName:imgname, sliderImage:imgfile, createdAt:date , deleted: false, published: false, status: "Draft", createdBy:Meteor.userId()});
	},
	'publishSliderData': function(title, imgname, imgfile, date){
		homeslider.insert({title:title, sliderName:imgname, sliderImage:imgfile, createdAt:date, deleted: false, published: true, status: "Published", createdBy:Meteor.userId()});
	},
