...
Template.adminHeader.helpers({
    'navBarList' : function(){
        return [
            ...
            {'title': 'posts', 'icon': 'fa-thumb-tack', 'subtitle': [{'sTitle':'add','title': 'posts','name':'AddNew'},{'sTitle':'tags','title': 'posts','name':'Tags'},{'sTitle':'image','title': 'posts','name':'FeaturedImage'}]},           
